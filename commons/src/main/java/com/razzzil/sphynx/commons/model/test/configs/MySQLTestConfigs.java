...
@Data
@Builder
public class MySQLTestConfigs extends TestConfigs {
...
//                    .build());
//        } else if (clients < 0 || clients > MAX_CLIENTS) {
//            validationResults.add(ValidationResult.builder()
//                    .fieldName(Fields.CLIENTS.getName())
//                    .description(StaticsConstants.ValidationPresets.formatCustom("%s must be greater than 0 and less than %d", Fields.CLIENTS.getName(), MAX_CLIENTS))
//                    .build());
//        }
